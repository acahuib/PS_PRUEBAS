...
class TestRF31ChildForm(SimpleTestCase):

    def test_FN3_CP_001_creacion_valida(self):
        data = {
            "first_name": "Lucas",
            "last_name": "Perez",
    ...
    def test_FN3_CP_002_nombre_vacio(self):
        data = {"first_name": "", "birth_date": datetime.date.today()}
        form = ChildForm(data=data)
        self.assertFalse(
    ...
    def test_FN3_CP_003_nombre_excede_limite(self):
        data = {"first_name": "A" * 256, "birth_date": datetime.date.today()}
        form = ChildForm(data=data)
        self.assertFalse(
            form.is_valid(),
    ...
    def test_FN3_CP_004_formato_fecha_invalido(self):
        data = {"first_name": "Lucas", "birth_date": "trece de marzo"}
        form = ChildForm(data=data)
        self.assertFalse(
            form.is_valid(),
    ...
    def test_FN3_CP_005_fecha_nacimiento_futura(self):
        ...
        data = {"first_name": "Lucas", "birth_date": tomorrow}
        form = ChildForm(data=data)
        self.assertFalse(
            form.is_valid(),
    ...
    def test_FN3_CP_006_formato_imagen_invalido(self):
        ...
        data = {"first_name": "Lucas", "birth_date": datetime.date.today()}
    ...
    def test_FN3_CP_007_fecha_nacimiento_antigua_ilogica(self):
        data = {"first_name": "Adulto", "birth_date": datetime.date(1970, 1, 1)}
        form = ChildForm(data=data)
        self.assertFalse(
            form.is_valid(),
