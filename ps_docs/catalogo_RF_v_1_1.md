...
| **Requisitos asociados**    | RF-004.1, RF-004.3, RF-004.6, RF-004.9, RF-004.10                                                                                                                                                                               |
...
| **Requisitos asociados**    | RF-004.2, RF-004.4, RF-004.11                                                                                                                                                |
...
| **Descripción**             | Permite a los administradores crear cuentas para otros cuidadores (con opción de solo lectura), y a los usuarios iniciar sesión, recuperar o cambiar su contraseña.                                                       |
| **Prioridad**               | Alta                                                                                                                                                                                                                      |
| **Criterios de aceptación** | - Debe validar credenciales únicas (email/usuario).<br>- Debe manejar encriptación de contraseñas y permitir al usuario cambiarla desde su perfil.<br>- Debe permitir recuperación de acceso mediante correo electrónico. |
...
| **Prioridad**               | Baja                                                                                                                                                                                                                                                                      |
| **Criterios de aceptación** | - Debe permitir configurar la tasa de refresco automático del dashboard.<br>- Debe permitir ocultar tarjetas vacías y configurar un límite de tiempo para ocultar datos antiguos.<br>- Debe permitir configurar el número de elementos por página en las vistas de lista. |
| **Requisitos asociados**    | RF-001.1                                                                                                                                                                                                                                                                  |

- **RF-002.4 - Gestión de API Keys y Dispositivos**

| **Código**                  | RF-002.4                                                                                                                                                                                    |
| :-------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Nombre**                  | Gestión de API Keys y Dispositivos                                                                                                                                                          |
| **Descripción**             | Permite al usuario generar claves de API para integraciones y proveer un acceso rápido mediante Código QR.                                                                                  |
| **Prioridad**               | Media                                                                                                                                                                                       |
| **Criterios de aceptación** | - Debe mostrar la clave API actual del usuario o permitir regenerarla (reset).<br>- Debe mostrar un Código QR de inicio de sesión basado en la clave API para asociar dispositivos móviles. |
| **Requisitos asociados**    | Ninguno                                                                                                                                                                                     |
...
| **Prioridad**               | Alta                                                                                                                        |
| **Criterios de aceptación** | - Debe validar campos obligatorios: nombre, fecha de nacimiento.<br>- Debe permitir subir o seleccionar una foto de perfil. |
...
| **Requisitos asociados**    | RF-001.1, RF-005.1, RF-006.1                                                                                                                                                 |
...
| **Requisitos asociados**    | RF-004.1, RF-004.11                                                                                                                                                                                                                                  |
...
| **Requisitos asociados**    | RF-001.1, RF-004.4, RF-005.1, RF-006.1                                                                                                                                                                              |
...
| **Requisitos asociados**    | RF-004.3, RF-004.11                                                                                                                                                                                                 |
...
| **Requisitos asociados**    | RF-004.11, RF-005.1                                                                                                                                                        |
...
| **Requisitos asociados**    | RF-001.1, RF-005.1                                                                                                                                                                   |
...
| **Prioridad**               | Media                                                                                                                                                                                                                                                           |
| **Criterios de aceptación** | - Debe permitir ingresar peso, altura y perímetro cefálico.<br>- Debe calcular o permitir registrar el Índice de Masa Corporal (IMC) y percentiles (solo para peso y altura).<br>- Debe permitir registrar la fecha de la medición y observaciones adicionales. |
| **Requisitos asociados**    | RF-003.1, RF-005.1                                                                                                                                                                                                                                              |
...
- **RF-004.10 - Registrar temperatura**

| **Código**                  | RF-004.10                                                                                                                                                |
| :-------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Nombre**                  | Registrar temperatura                                                                                                                                    |
| **Descripción**             | Permite ingresar registros de la temperatura corporal del bebé.                                                                                          |
| **Prioridad**               | Media                                                                                                                                                    |
| **Criterios de aceptación** | - Debe registrar la temperatura.<br>- Debe registrar la fecha y hora de la medición.<br>- Debe permitir agregar observaciones opcionales mediante notas. |
| **Requisitos asociados**    | RF-001.1, RF-005.1                                                                                                                                       |

**Submódulo: Gestión Global de Temporizadores**

- **RF-004.11 - Gestión de temporizadores en vivo**
...
- **RF-004.12 - Gestión de notas diarias**
...
| **Requisitos asociados**    | RF-004.13                                                                                                       |

- **RF-004.13 - Sistema de etiquetado (Tags)**
...
#### v. RF-005 – Generación de Reportes

- **RF-005.1 - Generar gráficas de actividades y salud**
...
| **Prioridad**               | Media                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Criterios de aceptación** | - Debe generar gráficas avanzadas (cantidades, intervalos, duraciones, promedios y patrones) de todas las actividades diarias (sueño, alimentación, extracción de leche, pañales, tummy time, medicación y temperatura).<br>- Debe calcular percentiles para métricas de crecimiento basadas en los estándares de la OMS por sexo (solo aplicable a peso y altura).<br>- Debe mostrar gráficas de evolución estándar para el perímetro cefálico y el IMC.<br>- Debe permitir visualizar tendencias a lo largo del tiempo. |
| **Requisitos asociados**    | RF-004.1, RF-004.3, RF-004.5, RF-004.6, RF-004.7, RF-004.8, RF-004.9, RF-004.10                                                                                                                                                                                                                                                                                                                                                                                                                                           |

#### vi. RF-006 – Configuración Global del Sistema

- **RF-006.1 - Ajustes globales de rutinas**

| **Código**                  | RF-006.1                                                                                                                                                                                                                                     |
| :-------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Nombre**                  | Ajustes globales de rutinas                                                                                                                                                                                                                  |
| **Descripción**             | Permite a los administradores definir reglas a nivel de sistema para el cálculo de tiempos entre actividades.                                                                                                                                |
| **Prioridad**               | Media                                                                                                                                                                                                                                        |
| **Criterios de aceptación** | - Debe permitir configurar si el tiempo entre comidas se calcula desde el inicio o el fin de la toma anterior.<br>- Debe permitir establecer el rango de horas predeterminado para considerar que una sesión de sueño es una "siesta" (nap). |
| **Requisitos asociados**    | RF-004.1, RF-004.3                                                                                                                                                                                                                           |
...
| :----- | :----------------- | :-------------------------------------------- | :---------------------------- | :---------------- | :--------------------------------------------------------------------- | :------------------------------------------------------------------------------- |
| RF-001 | Dashboard          | Ver resumen y accesos directos.               | Consultar estado actual       | Alta              | Actualización en tiempo real, mostrar última actividad.                | RF-004.1, RF-004.2, RF-004.3, RF-004.4, RF-004.6, RF-004.9, RF-004.10, RF-004.11 |
| RF-002 | Gestión de Cuentas | Registro, login, preferencias y API Keys.     | Administrar perfil de usuario | Alta              | Validación de credenciales, configuración de dashboard y zona horaria. | RF-001.1, RF-004.1                                                               |
...
| RF-004 | Registros Core     | Registrar sueño, comida, pañales y salud.     | Registrar actividad diaria    | Alta, Media, Baja | Validación de fechas/horas, manejo dinámico según tipo de registro.    | RF-001.1, RF-005.1                                                               |
| RF-005 | Reportes           | Visualizar gráficas de tendencias y patrones. | Visualizar estadísticas       | Media             | Gráficas y cálculo de percentiles (OMS).                               | RF-004.1, RF-004.3, RF-004.5, RF-004.6, RF-004.7, RF-004.8, RF-004.9, RF-004.10  |
| RF-006 | Config. Sistema    | Configuración global de cálculos.             | Administrar sistema           | Media             | Reglas para comidas y siestas.                                         | RF-004.1, RF-004.3                                                               |
